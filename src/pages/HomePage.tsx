...
export default function HomePage(): JSX.Element {
  ...
  return (
    <div
      className={`h-screen bg-gradient-to-t from-gray-300 via-gray-200 to-gray-100 flex flex-col items-center justify-center text-white relative bg-cover bg-center bg-no-repeat px-4 transition-opacity duration-1000 ${
    ...
    >
      ...
      <div className="md:mt-16 mt-12 font-medium text-zinc-800 text-center max-w-lg md:max-w-2xl text-md md:text-lg">
        ...
        <p className="mt-2  font-thin">
          Conscious, a AI powered second brain that helps you store, recall, and
