...
export function Auth() {
  ...
  return (
    <div className="flex md:flex-row flex-col justify-center gap-2">
        <h1 className="absolute top-0 m-10 text-center text-gray-300 text-lg bg-zinc-800 rounded p-2">Hosted on free instance, which can delay requests by 50 seconds or more due to inactivity, please wait. </h1>
