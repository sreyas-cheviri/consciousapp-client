...
const variantstyles = {
  ...
  secondary:
    " hover:bg-white/10 flex justify-center  items-center dark:hover:bg-zinc-400/20 dark:text-zinc-900 dark:bg-gray-200 border-gray-300/40 text-gray-300 rounded-xl  font-normal bg-zinc-700 hover:text-gray-300   transition duration-200 flex justify-center items-center",
