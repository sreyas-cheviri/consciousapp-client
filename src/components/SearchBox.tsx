...
const SearchBox = () => {
  return (
    <div className="bg-zinc-800 md:mt-10 mt-10 flex shadow-xl shadow-black/30 w-[355px] rounded-3xl md:w-[550px] border-gray-500/5 justify-between border p-1 text-gray-300 relative">
      <textarea
