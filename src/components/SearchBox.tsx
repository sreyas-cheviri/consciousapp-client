...
const SearchBox = ({ onChipSelect }: SearchBoxProps) => {
  ...
  return (
    <div className="bg-zinc-700 mt-5 mb-10 dark:bg-zinc-400 w-full flex flex-col  dark:text-zinc-900 dark:shadow-zinc-300 shadow-xl shadow-black/30  rounded-2xl md:w-[650px] border-gray-500/5 justify-between border p-1 text-gray-300 relative">
